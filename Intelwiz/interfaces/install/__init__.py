...
class install():
    ...
    def __init__(self):
        ...
        self.img_a_propos.set_from_file(os.path.join(INTELWIZ_PATH, os.path.join('images', 'a_propos.png')))
        ...
        json_data=open(os.path.join(INTELWIZ_PATH, os.path.join('core', 'modules.json')))
