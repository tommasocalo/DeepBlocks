...
setup(
    ...
    data_files=[
        (os.path.join('intelwiz', 'images'), [os.path.join('intelwiz', os.path.join('images', 'icone.png')),
                               os.path.join('intelwiz', os.path.join('images', 'a_propos.png'))]),
        (os.path.join('intelwiz', 'core'), [os.path.join('intelwiz', os.path.join('core', 'modules.json'))])
    ]
)
